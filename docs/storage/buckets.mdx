...
Buckets are containers for your objects. Every object in Fil Hyperspace lives inside a bucket.
...
- Globally unique across all Fil Hyperspace accounts
...
Fil Hyperspace supports cascade deletion -- you do not need to empty a bucket before deleting it. All objects in the bucket are permanently removed as part of the delete operation.
